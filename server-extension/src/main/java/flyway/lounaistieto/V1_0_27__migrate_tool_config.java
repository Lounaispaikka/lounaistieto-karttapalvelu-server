 ...
 */
public class V1_0_27__migrate_tool_config implements JdbcMigration {
    ...
    private boolean modifyConfig(Bundle bundle) throws Exception {
        ...
        config.append("mapUrlPrefix", "{\"fi\": \"https://karttapalvelu.lounaistieto.fi?lang=fi&\",\"sv\": \"https://karttapalvelu.lounaistieto.fi?lang=sv&\",\"en\": \"http://karttapalvelu.lounaistieto.fi?lang=en&\"}");
