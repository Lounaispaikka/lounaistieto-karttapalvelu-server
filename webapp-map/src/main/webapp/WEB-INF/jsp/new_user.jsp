    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-4">
            <form role="form">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="first_name" id="firstname" class="form-control input-lg"
                                       placeholder="Etunimi" value="${firstname}" tabindex="1" autofocus />
                            </div>
                        </div>
                    </span>
                    <span class="content-column">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="last_name" id="lastname"
                                       class="form-control input-lg" value="${lastname}" placeholder="Sukunimi" tabindex="2"/>
                            </div>
                        </div>
                    </span>
                </div>
                ...
                <span class="content-column">
                        <div class="form-group">
                            <input type="text" name="display_name" id="username" class="form-control input-lg"
                                   placeholder="Käyttäjätunnus" tabindex="3"/>
                        </div>
                    </span>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6"><input type="button" value="Rekisteröidy"
